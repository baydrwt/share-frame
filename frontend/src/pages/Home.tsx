  ...
  return (
    <Layout>
      <div className="heroSection relative w-full h-[80vh] m-0 p-0">
        {!isPlaying && (
          <div className="absolute flex flex-col justify-center items-center top-0 left-0 w-full h-full bg-gradient-to-tr from-black to-gray-700 ">
            ...
            <button className="bg-blue-500 text-white flex items-center justify-center w-16 h-16 rounded-full transition duration-300 ease-in-out hover:bg-blue-700 hover:shadow-lg hover:scale-105 transform animate-scale-pulse">
