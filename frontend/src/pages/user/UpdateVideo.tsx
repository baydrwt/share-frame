...
const UpdateVideo: React.FC = () => {
  ...
  const [isPrivate, setIsPrivate] = useState<string>(editVideo?.isPrivate !== undefined ? String(editVideo.isPrivate) : "false");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(`Something went wrong when updating ${error}`);
    }
  };
